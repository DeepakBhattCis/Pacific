...
window.bootbox = window.bootbox || (function init($, undefined) {
  "use strict";
    ...
    //MODIFIED, I ONLY ADDED A CLASS  containerBoldTitle , no hurt, it was the quick fix
    //IMPROVE <-  will remove it 
  var templates = {
    dialog:
      "<div class='bootbox modal' tabindex='-1' role='dialog'>" +
        "<div class='modal-dialog'>" +
          "<div class='modal-content' id='modalContent'>" +
            "<div class='modal-body'><div class='bootbox-body row'></div></div>" +
          "</div>" +
        "</div>" +
      "</div>",
    header:
      "<div class='modal-header'>" +
        "<h4 class='modal-title containerBoldTitle'></h4>" +   
      "</div>",
    footer:
